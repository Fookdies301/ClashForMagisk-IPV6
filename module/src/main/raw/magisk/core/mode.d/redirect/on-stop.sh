...
ip6tables -t nat -D OUTPUT -p tcp -j CLASH_LOCAL6
ip6tables -t nat -D PREROUTING -p tcp -j CLASH_EXTERNAL6

ip6tables -t nat -F CLASH_LOCAL6
ip6tables -t nat -X CLASH_LOCAL6

ip6tables -t nat -F CLASH_EXTERNAL6
ip6tables -t nat -X CLASH_EXTERNAL6
